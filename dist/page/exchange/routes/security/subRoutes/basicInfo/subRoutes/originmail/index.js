...
let OriginMail = class OriginMail extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'down'
            ...
            React.createElement(Row, { justify: "center" },
                React.createElement(Col, { className: "wrapper" },
                    ...
                    React.createElement(Row, { style: { paddingTop: "30px" }, justify: "center" },
                        React.createElement(Col, { className: "title" }, "\u539F\u90AE\u7BB1\u9A8C\u8BC1")),
                    React.createElement(Row, { style: { padding: "32px 40px 0", textAlign: "center" }, justify: "center" },
...
OriginMail = __decorate([
    inject('userStore'),
    observer
], OriginMail);
export default OriginMail;
