...
export default class Identification extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(WrappedIdentificationCmp, null,
            React.createElement(Row, { justify: "center", className: "title" }, "\u4F01\u4E1A\u8BA4\u8BC1"),
            React.createElement(Row, { id: "institutionIdentificationBox", className: "mainBox" },
                React.createElement(InstitutionLayout, Object.assign({}, layoutProps)),
