...
const enterprise = require("@webExchangeImgs/kyc/enterprise.png");
const enterpriseActive = require("@webExchangeImgs/kyc/enterpriseActive.png");
const upload = require("@webExchangeImgs/kyc/upload.png");
const uploadActive = require("@webExchangeImgs/kyc/uploadActive.png");
const member = require("@webExchangeImgs/kyc/member.png");
const memberActive = require("@webExchangeImgs/kyc/memberActive.png");
...
const WrappedInstitutionLayoutCmp = styled.div `
    .layoutCmp {
        width: 310px;
    ...
    .navBar {
        ...
        .navItem {
            ...
            &.enterpriseInfo {
                ...
                &.active::before {
                    background-image: url(${enterpriseActive});
                }
            }
            &.uploadFile {
                &::before {
                ...
                &.active::before {
                    background-image: url(${uploadActive});
                }
            }
            &.memberInfo {
                &::before {
                ...
                &.active::before {
                    background-image: url(${memberActive});
                }
            }
            &.financialInfo {
                &::before {
...
`;
export { WrappedInstitutionLayoutCmp };
