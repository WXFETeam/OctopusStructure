...
const { Option } = Select;
let GAClose = class GAClose extends React.Component {
    constructor(props) {
        super(props);
        this.handleSubmit = () => {
            let { smsCode, gaCode, loginPwd } = this.state;
            ajax({
                url: 'MFA.mfaModify',
                data: {
                    gaCode,
    ...
    render() {
        ...
        return (React.createElement(WrapperGACmp, null,
            React.createElement(Row, { justify: "center", style: { height: '100%', paddingTop: 100 } },
                React.createElement("div", { className: "title" }, "\u5173\u95ED\u8C37\u6B4C\u9A8C\u8BC1"),
                React.createElement("div", { className: "frame" },
                    ...
                    codeType === '3' ?
                        React.createElement("div", { className: "content" },
                            ...
                            React.createElement("div", { className: "pointBox" },
                                React.createElement("a", { className: "forgetGa" }, "\u4E22\u5931\u8C37\u6B4C\u9A8C\u8BC1\uFF1F"))) : '',
                    React.createElement(Button, { className: "confirmBtn", onClick: this.handleSubmit.bind(this) }, "\u786E\u8BA4")))));
    }
};
GAClose = __decorate([
