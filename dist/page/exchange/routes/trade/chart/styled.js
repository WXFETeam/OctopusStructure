...
const customizeStyleCmpList = ['bgColor', 'shadowColor'];
const cmpNS = 'Trade';
...
var { actionBtnColor, actionBgColor, actionSelectedBtnColor, actionSelectedBgColor, actionArrowDown, actionArrowUp, actionFullScreen, actionFullScreenActive, actionMinScreen, actionMinScreenActive } = getMulThemeProps.themeProps(chartStyleCmpList, chartCmpNS);
...
`;
export { WrapperChartCmp, WrapperActionsCmp, WrapperDepthCmp };
