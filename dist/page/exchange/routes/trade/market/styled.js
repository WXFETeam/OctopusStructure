...
const cmpNS = 'Trade.Market';
var { curInstrumentTextColor, titleTextColor, contentTextColor, upTextColor, downTextColor, instrumentsListBoxBorderColor, instrumentListBoxBG, tabNavTextColor, tabNavSelectedTextColor, tabNavSelectedUnderlineColor, tabNavUnderlineColor, searchBoxBGColor, searchBGColor, searchBorderColor, instrumentDetailsTitleBGColor, instrumentDetailsTitleBorderColor, instrumentDetailsTitleColor, contentBoxTextColor, eachLineBGColor, scrollbarThumbColor, scrollbarTrackColor, arrowDown, arrowUp, favorite, favoriteHover, favoriteActive } = getMulThemeProps.themeProps(customizeStyleCmpList, cmpNS);
...
`;
export { WrapperMarketCmp, WrapperInstrumentsList, WrapperInstrumentsSearch, WrapperInstrumentsDetails };
