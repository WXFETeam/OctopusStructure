...
const cmpNS = 'Trade.BuyOrSell';
var { textColor, inputLabelColor, titleColor, activeTextColor, boxShadow, headerBgColor, headerFeesIcon, headerFeesIconActive, contentBgColor, contentBuyColor, contentSellColor, contentTabTextColor, contentTabSelectedTextColor, contentTabSelectedBorderColor, contentInputTextColor, contentInputBgColor, contentInputLimitValueBgColor, contentInputBorderColor, contentInputFocusBorderColor, contentInputDisabledTextColor, contentInputDisabledBgColor, btnActiveColor, feesDetailBorderColor, feesDetailBgColor, feesDetailTextColor, feesDetailBtnColor, tabSelectBgColor, tabSelectBorderColor, tabSelectTextColor, tabSelectedTextColor, orderAgingTitColor, orderAgingBorderColor } = getMulThemeProps.themeProps(customizeStyleCmpList, cmpNS);
...
`;
export { WrapperBuyOrSellCmp, WrapperOrderAging, WrapperMarketCmp, WrapperLimitCmp, WrapperStopCmp, WrapperAmountCmp };
