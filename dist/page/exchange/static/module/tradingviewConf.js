...
const widget = () => {
    ...
    return {
        ...
        custom_css_url: env != 'development' ? `/common/charting_library/static/${overrideConfig.cssPage}` : `/common/assets/js/vendor/charting_library/static/${overrideConfig.cssPage}`,
    };
};
export default {
    resolutions: [{
...
//# sourceMappingURL=tradingviewConf.js.map