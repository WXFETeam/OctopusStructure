...
const buyOrSellCmpNS: string = 'Trade.BuyOrSell';
const buyOrSellStyleCmpList: string[] = [
    'tabSelectBgColor',
...
const primaryCmpNS: string = 'Primary.Button';
const primaryStyleCmpList: string[] = [
    'blueDefaultColor',
    'blueHoverColor',
    'bluePressedColor',
    'greenDefaultColor',
