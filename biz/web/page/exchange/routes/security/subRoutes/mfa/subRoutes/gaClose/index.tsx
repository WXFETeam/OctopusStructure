...
export default class GAClose extends React.Component<GAProps, GAState> {
        ...
        return (
            <WrapperGACmp>
                <Row justify="center" style={{ height: '100%', paddingTop: 100 }}>
                    <div className="title">关闭谷歌验证</div>
                    <div className="frame">
                        ...
                        <Button className="confirmBtn" onClick={this.handleSubmit.bind(this)}>确认</Button>
                    </div>
                </Row>
            </WrapperGACmp>
        )
